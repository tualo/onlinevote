...
VALUES
    (
        'bp_column',
        'bp_row',
        '{\"bp_column__row_name\":\"bp_row__row_name\"}',
        1,
        'fk_bp_column_row_name',
        0,
        0,
        999,
        '\'\'',
...
VALUES
    ('administration', 'bp_column', 1, 1, 1, 1, 0),
    ('_default_', 'bp_column', 1, 0, 0, 0, 0);