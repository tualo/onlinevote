    ...
    public static function register(){
        BasicRoute::add('/onlinevote/append/publickey',function(){
            ...
            try{
                ...
                if (!isset( $_REQUEST['publickey'] )&&!is_string($_REQUEST['publickey'])) throw new \Exception("Ein Attribut wir vermisst");
                if (!isset( $_REQUEST['name'] )&&!is_string($_REQUEST['publickey'])) throw new \Exception("Ein Attribut wir vermisst");
