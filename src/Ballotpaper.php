...
class Ballotpaper
{
    ...
    protected function setVoterId(int $voter_id)
    {
        $this->voter_id = $voter_id;
    }
    protected function setTs(string $ts)
    {
        $this->ts = $ts;
    }
    protected function setBallotpaperId(int $ballotpaper_id)
    {
        $this->ballotpaper_id = $ballotpaper_id;
    }
    protected function setBallotpaperName(string $ballotpaper_name)
    {
        $this->ballotpaper_name = $ballotpaper_name;
    }
    protected function setVoterData(array $voter_data)
    {
        $this->voter_data = $voter_data;
    }
    protected function setCanvote(int $canvote)
    {
    ...
    protected function setFilled(array $filled)
    {
        $this->filled = $filled;
    }
    protected function setSecretToken(string $secret_token)
    {
    ...
    public function getBallotpaperId(): int
    {
        return $this->ballotpaper_id;
    }
    public function getBallotpaperName(): string
    {
        return $this->ballotpaper_name;
    }
    public function getVoterData(): array
    {
        return $this->voter_data;
    }
    ...
    public function register(): void
    {
        ...
        $db->direct($sql, [
            'voter_id'      =>  $this->getVoterId(),
            'stimmzettel'   => ((string)$this->getBallotpaperId()),
    ...
    public function save(): void
    {
        ...
        try {
            App::logger('Ballotpaper(function save)')->debug(__LINE__ . '');
            ...
            foreach ($pgpkeys as $keyitem) {
                ...
                $hash['stimmzettel']    =   $this->getBallotpaperId();
                ...
                insert into ballotbox 
                    (id,keyname,ballotpaper,voter_id,stimmzettel,isvalid) 
                values 
                    ({token},{keyname},{ballotpaper},{voter_id},{stimmzettel},{isvalid})',
                    $hash
                );
            }
            App::logger('Ballotpaper(function save)')->debug(__LINE__ . '');
